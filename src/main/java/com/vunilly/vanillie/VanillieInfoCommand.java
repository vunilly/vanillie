    ...
    private static void openInfoBook(Player player) {
        ...
        meta.addPages(
                Vanillie.minimessage.deserialize("""
                        ...
                        Command infos on next pages ->
                        """),
                Vanillie.minimessage.deserialize("""
                        [info|<b>tag</b>|vote|pvp]
                        <b>/tag</b>
                        Add Tags before your username (Tablist, Chat, Above player)
                        """),
                Vanillie.minimessage.deserialize("""
                        [info|tag|<b>vote</b>|pvp]
                        <b>/vote</b>
                        Vote for a time or weather
                        """),
                Vanillie.minimessage.deserialize("""
                        [info|tag|vote|<b>pvp</b>]
                        <b>/pvp</b>
                        Turn pacifist mode on or off (has 3 mins cooldown)
                        """));
