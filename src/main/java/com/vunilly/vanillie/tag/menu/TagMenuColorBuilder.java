...
import com.vunilly.vanillie.utils.Colors;
    ...
    public void setupInventory() {
        ...
        for (String colorHexCode : colorList) {
            ...
            ItemStack colorButton = Utils.getUiButton(colorStack,
                    ...
                    counter + 1,
                    Lang.get("menu.tag.colorBuilder.color.desc", Placeholder.parsed("hexcode", colorHexCode)));
            ...
            if (slotId == addColorButtonSlot) {
                ColorList tagMenuColorList = new ColorList(
                        ...
                        (gewaehlterHex) -> {
                            ...
                            TagMenuColorBuilder tagmenuColorBuilder = new TagMenuColorBuilder(player, this.colorList,
                                    this.tagText);
                            player.openInventory(tagmenuColorBuilder.getInventory());
                        },
                        () -> {
