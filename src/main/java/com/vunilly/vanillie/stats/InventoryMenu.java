...
public class InventoryMenu implements ClickMenu {
    private Inventory inventory;
    private UUID senderUUID;
    private UUID playerUUID;
    private String name;

    public InventoryMenu(Player player, String getFromPlayerName, UUID playerUUID) {
        this.inventory = Bukkit.createInventory(this, 54, Lang.get("menu.stats.inventory.title",
    ...
    private void setupInventory() {
        ...
        try {
            ...
            ListTag<?> inventoryData = playerData.getListTag("Inventory");
            ...
            Bukkit.getLogger().warning("[Vanillie] An error occurred while trying to get Inventory contents: " + e);
        }
    }
